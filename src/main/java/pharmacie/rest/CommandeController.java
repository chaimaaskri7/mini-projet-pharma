...
public class CommandeController {
    ...
    public ResponseEntity<LigneDTO> ajouterLigne(@RequestParam int commandeNum, @RequestParam int medicamentRef,
    ...
    public ResponseEntity<List<EnTeteCommandeDTO>> getCommandeEnCoursPour(
            @PathVariable @NonNull String dispensaireCode) {
        ...
        // List<EnTeteCommandeDTO> result = commandes.stream().map(commande ->
        // mapper.map(commande, EnTeteCommandeDTO.class)).collect(Collectors.toList());
